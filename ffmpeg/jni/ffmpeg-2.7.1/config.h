...
#define FFMPEG_CONFIGURATION "--arch=arm --enable-neon --enable-thumb --pkg-config=pkg-config --enable-gpl --enable-nonfree --enable-runtime-cpudetect --enable-gray --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --disable-w32threads --disable-os2threads --enable-pthreads --disable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-devices --disable-decoders --enable-decoder=aac --enable-decoder=adts --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=png --enable-decoder=gif --enable-decoder='pcm*' --enable-encoder=libfaac --enable-encoder=libx264 --enable-encoder=libx264rgb --enable-encoder=png --enable-encoder=aac --enable-encoder=libfdk_aac --enable-encoder='pcm*' --disable-muxers --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mp3 --enable-muxer=aac --enable-muxer=h264 --enable-muxer=png --enable-muxer=gif --enable-muxer='pcm*' --disable-demuxers --enable-demuxer=aac --enable-demuxer=h264 --enable-demuxer=mp4 --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=png --enable-demuxer=gif --enable-demuxer='pcm*' --disable-parsers --enable-parser=aac --enable-parser=h264 --disable-filters --disable-bsfs --enable-protocols --disable-protocol=bluray --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol=pipe --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=unix --enable-libx264 --disable-iconv --disable-asm --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-debug --prefix=/Users/luofan/code/Zentertain/ZenMediaLib/ffmpeg/jni/ffmpeg-2.7.1/build/ffmpeg-armv7a/output --cross-prefix=/Users/luofan/Library/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --enable-cross-compile --target-os=linux --cc=/Users/luofan/Library/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --nm=/Users/luofan/Library/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --sysroot=/Users/luofan/Library/android-ndk-r10d/platforms/android-16/arch-arm --enable-asm --enable-inline-asm --extra-cflags=-I../x264/build/x264/android/include --extra-ldflags=-L../x264/build/x264/android/lib --extra-cflags=' -O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/Users/luofan/code/Zentertain/ZenMediaLib/ffmpeg/jni/ffmpeg-2.7.1/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/luofan/code/Zentertain/ZenMediaLib/ffmpeg/jni/ffmpeg-2.7.1/build/ffmpeg-armv7a/output/share/ffmpeg"
