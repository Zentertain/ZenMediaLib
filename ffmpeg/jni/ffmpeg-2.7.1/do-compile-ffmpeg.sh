...
if [ "$FF_ARCH" = "armv7a" ]; then
    ...
    #export PKG_CONFIG_PATH=$FF_BUILD_ROOT/$FF_BUILD_NAME/pkg-config
...
FF_CFG_FLAGS="$FF_CFG_FLAGS --cc=${FF_TOOLCHAIN_PATH}/bin/arm-linux-androideabi-gcc"
FF_CFG_FLAGS="$FF_CFG_FLAGS --nm=${FF_TOOLCHAIN_PATH}/bin/arm-linux-androideabi-nm"
...
ln -s $FF_PREFIX/libzenffmpeg.so $FF_PREFIX/shared/lib/libzenffmpeg.so
